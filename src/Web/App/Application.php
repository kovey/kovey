...
class Application
{
     ...
     * @return null
     */
    public function console($path, $method, $args, $traceId)
    {
     ...
     * @return Array
     */
    public function workflow(\Swoole\Http\Request $request, $traceId)
    {
     ...
     * @return Array
     */
    public function runAction(RequestInterface $req, ResponseInterface $res, RouterInterface $router, $traceId)
    {
        ...
        $obj = $this->container->get($router->getClassName(), $traceId, $req, $res, $template, $this->plugins);
